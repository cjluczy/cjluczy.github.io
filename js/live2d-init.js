(() => {
  ...
  const boot = () => {
    ...
    if (window.__cz_blog_live2d_loading || window.__cz_blog_live2d_initialized) return
    if (document.getElementById('waifu')) {
      window.__cz_blog_live2d_initialized = true
      return
    }

    window.__cz_blog_live2d_loading = true
    ...
    Promise.all([
      ...
      window.__cz_blog_live2d_loading = false
    })
  }
